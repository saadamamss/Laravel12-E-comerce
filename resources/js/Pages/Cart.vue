    ...
    <DefaultLayout>
        <main id="main" class="main-site">
            <div class="container">
                        ...
                        <div v-if="cart?.count > 0">
                            <div class="wrap-iten-in-cart">
                                ...
                                <ul class="products-cart">
                                    <li
                                        class="pr-cart-item"
                                        v-for="(item, index) in cart.content"
                                        :key="index"
                                    >
                                        <div class="product-image">
                                            <figure>
                                                <img
                                                    v-if="item.model?.images"
                                                    :src="`/assets/images/products/${
                                                        item.model?.images?.split(
                                                            ','
                                                        )[0]
                                                    }`"
                                                    alt=""
                            ...
                            <div class="row mx-0 border py-3 px-3 gap-y-5">
                                <div class="col-12 col-md-4">
                                    <h4 class="text-lg md:text-xl mb-3">
                                        Order Summary
                                    </h4>
                                    <p
                                    ...
                                    >
                                        ...
                                        ><b class="text-sm">Free Shipping</b>
                                    </p>
                                    <p
                                        class="flex justify-between mb-3 font-bold"
                                    >
                                    ...
                                    <hr />
                                    <p
                                        class="flex justify-between mt-3 font-bold"
                                    >
                                ...
                                <!-- checkout btn -->
                                <div
                                    class="col-12 col-md-3 d-flex flex-column gap-3 justify-end mt-5 md:mt-0"
                                >
                                    <!-- clear cart btn -->
                                    ...
                                    <button
                                        ...
                                        :disabled="
                                            clearCartLoader ? true : undefined
                                        "
                                    >
                ...
                <ProductSectionView
                    v-if="props.data.public_products.length"
                    title="Most Viewed"
